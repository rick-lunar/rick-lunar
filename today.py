...
if __name__ == '__main__':
    """
    Rick Lunar (rick-lunar), 2022-2026
    """
    print('Calculation times:')
    # define global variable for owner ID and calculate user's creation date
    # e.g {'id': '116326335'} and 2019-11-03T21:15:07Z for username 'Andrew6rant'
    user_data, user_time = perf_counter(user_getter, USER_NAME)
    OWNER_ID, acc_date = user_data
    formatter('account data', user_time)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2006, 8, 13))
    ...
    if OWNER_ID == {'id': '116326335'}: # only calculate for user Andrew6rant
